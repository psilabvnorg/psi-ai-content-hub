...
from ..services.image_search.image_pipeline.orchestrator import run_pipeline
...
SOURCE_CATALOG: list[dict[str, str | bool]] = [
    ...
    {"id": "public_domain_archive", "name": "Public Domain Archive", "category": "art", "requires_key": False},
