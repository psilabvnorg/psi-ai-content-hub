...
export const mainVideoSchema = z.object({
  ...
  // Content directory for dynamic asset loading (e.g., 'main/education')
  contentDirectory: z.string().describe('Directory path for content assets'),
  ...
  // Section slider (loaded from section-mapping.json)
  sections: z.array(
    z.object({
      title: z.string(),
      startMs: z.number(),
    })
  ).default([]).describe('Named sections shown in the section slider overlay'),
});

export type MainVideoProps = z.infer<typeof mainVideoSchema>;

export const Education: React.FC<MainVideoProps> = ({
  introProps,
  images,
  audioSrc,
  captions,
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#000' }}>
      ...
      {/* ========== LAYER 3: Section Slider (zIndex 50) ========== */}
      {sections.length > 0 && (
      ...
      {/* ========== LAYER 4 (TOP-MOST): Captions (zIndex 100) ========== */}
